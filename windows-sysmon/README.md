...
3. The mapping configuration is deployed with the OCSF transformation Lambda function. A sample configuration can be found in the [transformation_code_infrastructure folder](./transformation_code_infrastructure/code/sysmon_mapping.json)
